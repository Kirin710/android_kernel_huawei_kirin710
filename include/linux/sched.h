...
#ifdef CONFIG_SCHED_HISI_TASK_MIN_UTIL
	struct cpu_cap_request		cpu_cap_req;
#endif
...
#ifdef CONFIG_SCHED_HISI_VIP
int set_hisi_vip_prio(struct task_struct *p, unsigned int prio);
#endif

#ifdef CONFIG_SCHED_HISI_TASK_MIN_UTIL
extern int set_task_min_util(struct task_struct *p, unsigned int min_util);
#else
