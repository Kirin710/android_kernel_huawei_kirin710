 ...
 * imx498hybird.c
 *
 * driver for imx498hybird sensor.
 *
...
static bool s_imx498hybird_power_on = false; //false for power down, ture for power up
...
static struct sensor_power_setting imx498hybird_power_down_setting[] = {
...
static struct sensor_power_setting imx498hybird_power_setting_v2[] = {
    //disable front caemra reset
    {
        .seq_type = SENSOR_SUSPEND,
        .config_val = SENSOR_GPIO_LOW,//SUSPEND type use real gpio status
...
static struct sensor_power_setting imx498hybird_power_down_setting_v2[] = {
    // M1 RESET  [GPIO_012]
    {
        .seq_type = SENSOR_RST2,
...
static int imx498hybird_config_power_on(hwsensor_intf_t* si)
{
    int ret = 0;
    ...
    if (!s_imx498hybird_power_on){
        ret = si->vtbl->power_up(si);
        if (0 == ret) {
            s_imx498hybird_power_on = true;
        } else {
...
static int imx498hybird_config_power_off(hwsensor_intf_t* si)
{
    int ret = 0;
    mutex_lock(&imx498hybird_power_lock);
...
static int imx498hybird_config_match_id(hwsensor_intf_t* si, void *argp)
{
    int ret = 0;
        ...
        void  *argp)
{
    ...
    switch(data->cfgtype){
        case SEN_CONFIG_POWER_ON:
            ret = imx498hybird_config_power_on(si);
            break;
        case SEN_CONFIG_POWER_OFF:
            ret = imx498hybird_config_power_off(si);
            break;
        ...
        case SEN_CONFIG_MATCH_ID:
            ret = imx498hybird_config_match_id(si, argp);
            break;
...
static sensor_t s_imx498hybird =
{
    ...
    .power_down_setting_array = {
        .size = ARRAY_SIZE(imx498hybird_power_down_setting),
        .power_setting = imx498hybird_power_down_setting,
    },
};

static sensor_t s_imx498hybird_v2 =
{
    .intf = { .vtbl = &s_imx498hybird_vtbl, },
    .power_setting_array = {
        .size = ARRAY_SIZE(imx498hybird_power_setting_v2),
        .power_setting = imx498hybird_power_setting_v2,
    },
    .power_down_setting_array = {
        .size = ARRAY_SIZE(imx498hybird_power_down_setting_v2),
        .power_setting = imx498hybird_power_down_setting_v2,
    },
};

/* support both imx498hybird & imx498legacydual */
static const struct of_device_id
s_imx498hybird_dt_match[] =
{
    {
        .compatible = "huawei,imx498hybird",
        .data = &s_imx498hybird.intf,
    },
    {
        .compatible = "huawei,imx498hybird_v2",
        .data = &s_imx498hybird_v2.intf,
    },
    { } /* terminate list */
};
...
static int32_t imx498hybird_platform_probe(struct platform_device* pdev);
static int32_t imx498hybird_platform_remove(struct platform_device* pdev);
static struct platform_driver
s_imx498hybird_driver =
{
    .probe = imx498hybird_platform_probe,
    .remove = imx498hybird_platform_remove,
    .driver =
    {
        .name = "huawei,imx498hybird",
        .owner = THIS_MODULE,
