...
static SINT32 vp8hal_cfgreg(omxvdh_reg_cfg_s *vdh_reg_cfg)
{
	...
	((ystaddr_1d *)(&d32))->ystaddr_1d =
		(vdh_reg_cfg->vdh_yst_addr) & 0xFFFFFFF0; // caution
							   ...
							   UINT32 *pic_width_mb)
{
	...
	((vp8_picdnmsg_d36 *)(&d32))->sed_top_addr =
		(hw_mem->sed_top_addr + 0xF) & 0xFFFFFFF0;   // caution!!
	wr_msgword(p32, d32);
	...
	((vp8_picdnmsg_d37 *)(&d32))->pmv_top_addr =
		(hw_mem->pmv_top_addr + 0xF) & 0xFFFFFFF0;   // caution!
	wr_msgword(p32, d32);
	...
	((vp8_picdnmsg_d38 *)(&d32))->rcn_top_addr =
		(hw_mem->rcn_top_addr + 0xF) & 0xFFFFFFF0;   // caution!
	wr_msgword(p32, d32);
	...
	((vp8_picdnmsg_d39 *)(&d32))->tab_addr =
		(hw_mem->vp8_tab_addr + 0xF) & 0xFFFFFFF0; // caution!
	wr_msgword(p32, d32);
	...
	((vp8_picdnmsg_d40 *)(&d32))->dblk_top_addr =
		(hw_mem->dblk_top_addr + 0xF) & 0xFFFFFFF0; // caution!
	wr_msgword(p32, d32);
