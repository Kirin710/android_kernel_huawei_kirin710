...
typedef int (*cleartext_func_t)(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
...
static int system_reg_prase(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
static int head_info_prase(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
static int lpm3_exc_special_prase(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
static int lpm3_core_reg_prase(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
static int lpm3_nvic_reg_prase(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
static int lpm3_log_prase(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
static int lpmcu_runtime_prase(const char *dir_path, struct file *fp, u64 log_addr, u32 log_len);
...
log_lpm3_cleartext_t g_lpm3_cleartext[] = {
		...
		{"IRQ_TRACE", M3_RDR_SYS_CONTEXT_EXPOSE_STORAGE_OFFSET + IRQ_TRACE_OFFSET, INT_TRACK_SIZE, irq_trace_parse},
		{"TASK_TRACE", M3_RDR_SYS_CONTEXT_EXPOSE_STORAGE_OFFSET + TASK_TRACE_OFFSET, TASK_TRACK_SIZE, task_trace_parse},
...
static int rdr_hisi_lpm3_cleartext_print(const char *dir_path, u64 log_addr, u32 log_len)
{
	bool error = false;
	u8 idx;
	u64 log_addr_prase;
