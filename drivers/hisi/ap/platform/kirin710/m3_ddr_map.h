...
#endif
#endif
#define LPMCU_RAM_SIZE (168*1024)
#define UCE_RAM_SIZE (16*1024)
#ifdef __FASTBOOT__
...
#define M3_DDR_SHARE_MEM_AGE_ADDR (M3_DDR_STORAGE_MEM_DDR_MPU_ADDR + M3_DDR_STORAGE_MEM_DDR_MPU_SIZE)
