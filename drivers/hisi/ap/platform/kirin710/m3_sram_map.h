...
#define LPMCU_DDR_DATA_SEC_SIZE (0x3400)
...
#define AON_SYS_SIZE (0x8800 - AON_SYS_RESERVED_SIZE)
...
#define SYS_CODE_SEC_RESERVED_SIZE (0x400)
#define SYS_CODE_SEC_SIZE (0x14C00-SYS_CODE_SEC_RESERVED_SIZE)
...
#define SYS_BSS_SEC_SIZE (0x3800-SYS_BSS_SEC_RESERVED_SIZE)
...
#define LPMCU_DDR_MNTN_SIZE (0x1400)
    #define DDRC_SAVE_TMP_BASE (LPMCU_DDR_MNTN_BASE + 0x400)
