...
#define RUNTIME_GPU_CTRL_ADDR (RUNTIME_VAR_BASE + 0x4D)
...
#define RUNTIME_GPU_IPC_RCV_TIME_ADDR (RUNTIME_SHARE_MEM_END_ADDR + 0x040)
#define GPU_IPC_RCV_TIME (WORD_REF(RUNTIME_GPU_IPC_RCV_TIME_ADDR))
#define RUNTIME_BUGON_REASON_ADDR (RUNTIME_SHARE_MEM_END_ADDR + 0x044)
