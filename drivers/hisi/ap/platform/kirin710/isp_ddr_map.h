...
#define MEM_ISP_RDR_OFFSET (0x6C0000)
...
#define ISP_TEXT_SIZE (0x00400000)
#define DATA_BASE (0xc0400000)
#define ISP_DATA_SIZE (0x00C00000)
#define ISP_BIN_DATA_SIZE (0x00800000)
...
#define STATIC_REGION_NSEC_NUM (15)
