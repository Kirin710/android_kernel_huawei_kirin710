...
#define GET_FLUX_REQ_IN(max_depth) ((max_depth) * 60 / 100)
...
#define MEDIA_CRG_BASE (0xE87FF000)
...
#define DSS_GLB_PMM_OFFSET (0x94000)
#define DSS_ITF_PMM_OFFSET (0x95000)
#define DSS_DSI_PMM_OFFSET (0x91000)
...
#define MCTRL_SYS_PMM_OFFSET (0x93000)
...
#define DSS_RCH_VG1_ARSR_LUT_OFFSET (0x2D000)
...
#define DSS_DPP_DEGAMMA_OFFSET (0x70938)
...
#define GLB_MMBUF_CFG_SECU_EN (DSS_GLB0_OFFSET + 0x0008)
#define GLB_ASC_CFG_SECU_EN (DSS_GLB0_OFFSET + 0x000C)
...
#define GLB_DSLP_EN (DSS_GLB0_OFFSET + 0x0608)
#define PMM_PDP_INTS (DSS_GLB_PMM_OFFSET + 0x0000)
#define PMM_PDP_INT_MSK (DSS_GLB_PMM_OFFSET + 0x0004)
#define PMM_SDP_INTS (DSS_GLB_PMM_OFFSET + 0x0008)
#define PMM_SDP_INT_MSK (DSS_GLB_PMM_OFFSET + 0x000C)
#define PMM_OFF_INTS (DSS_GLB_PMM_OFFSET + 0x0010)
#define PMM_OFF_INT_MSK (DSS_GLB_PMM_OFFSET + 0x0014)
#define PMM_OFF_CAM_INTS (DSS_GLB_PMM_OFFSET + 0x0018)
#define PMM_OFF_CAM_INT_MSK (DSS_GLB_PMM_OFFSET + 0x001C)
#define DBG_IRQ_PMM (DSS_GLB_PMM_OFFSET + 0x0020)
#define PMM_ITF_INTS (DSS_ITF_PMM_OFFSET + 0x0000)
#define PMM_ITF_INT_MSK (DSS_ITF_PMM_OFFSET + 0x0004)
#define DPI_PMM_GATE (DSS_ITF_PMM_OFFSET + 0x0010)
#define DP_DSI_PMM_GATE (DSS_ITF_PMM_OFFSET + 0x0014)
#define PROT_CFG_EN (DSS_DSI_PMM_OFFSET + 0x0068)
#define GEN_HDR (DSS_DSI_PMM_OFFSET + 0x006C)
#define GEN_PLD_DATA (DSS_DSI_PMM_OFFSET + 0x0070)
...
#define AIF_CH_HS_0 (DSS_VBIF0_AIF + 0x04)
#define AIF_CH_LS_0 (DSS_VBIF0_AIF + 0x08)
#define AIF0_CH1_OFFSET (DSS_VBIF0_AIF + 0x20)
#define AIF_CH_HS_1 (DSS_VBIF0_AIF + 0x24)
#define AIF_CH_LS_1 (DSS_VBIF0_AIF + 0x28)
#define AIF0_CH2_OFFSET (DSS_VBIF0_AIF + 0x40)
#define AIF_CH_HS_2 (DSS_VBIF0_AIF + 0x44)
#define AIF_CH_LS_2 (DSS_VBIF0_AIF + 0x48)
#define AIF0_CH3_OFFSET (DSS_VBIF0_AIF + 0x60)
#define AIF_CH_HS_3 (DSS_VBIF0_AIF + 0x64)
#define AIF_CH_LS_3 (DSS_VBIF0_AIF + 0x68)
#define AIF0_CH4_OFFSET (DSS_VBIF0_AIF + 0x80)
#define AIF_CH_HS_4 (DSS_VBIF0_AIF + 0x84)
#define AIF_CH_LS_4 (DSS_VBIF0_AIF + 0x88)
#define AIF0_CH5_OFFSET (DSS_VBIF0_AIF + 0xA0)
#define AIF_CH_HS_5 (DSS_VBIF0_AIF + 0xa4)
#define AIF_CH_LS_5 (DSS_VBIF0_AIF + 0xa8)
#define AIF0_CH6_OFFSET (DSS_VBIF0_AIF + 0xC0)
#define AIF_CH_HS_6 (DSS_VBIF0_AIF + 0xc4)
#define AIF_CH_LS_6 (DSS_VBIF0_AIF + 0xc8)
#define AIF0_CH7_OFFSET (DSS_VBIF0_AIF + 0xE0)
#define AIF_CH_HS_7 (DSS_VBIF0_AIF + 0xe4)
#define AIF_CH_LS_7 (DSS_VBIF0_AIF + 0xe8)
#define AIF0_CH8_OFFSET (DSS_VBIF0_AIF + 0x100)
#define AIF_CH_HS_8 (DSS_VBIF0_AIF + 0x104)
#define AIF_CH_LS_8 (DSS_VBIF0_AIF + 0x108)
#define AIF0_CH9_OFFSET (DSS_VBIF0_AIF + 0x120)
#define AIF_CH_HS_9 (DSS_VBIF0_AIF + 0x124)
#define AIF_CH_LS_9 (DSS_VBIF0_AIF + 0x128)
#define AIF0_CH10_OFFSET (DSS_VBIF0_AIF + 0x140)
#define AIF_CH_HS_10 (DSS_VBIF0_AIF + 0x144)
#define AIF_CH_LS_10 (DSS_VBIF0_AIF + 0x148)
#define AIF0_CH11_OFFSET (DSS_VBIF0_AIF + 0x160)
#define AIF_CH_HS_11 (DSS_VBIF0_AIF + 0x164)
#define AIF_CH_LS_11 (DSS_VBIF0_AIF + 0x168)
#define AIF0_CH12_OFFSET (DSS_VBIF0_AIF + 0x180)
#define AIF_CH_HS_12 (DSS_VBIF0_AIF + 0x184)
#define AIF_CH_LS_12 (DSS_VBIF0_AIF + 0x188)
...
#define AIF_MONITOR_READ_CYCLE (0x0870)
#define AIF_MONITOR_WINDOW_CYCLE (0x0880)
#define AIF_MONITOR_WRITE_DATA (0x0884)
#define AIF_MONITOR_WR_CMD_CNT (0x0888)
#define AIF_MONITOR_WR_DONE_CNT (0x088C)
#define AIF_MONITOR_WBURST_CNT (0x0890)
#define AIF_MONITOR_AVR_WR_CYCLE (0x0894)
#define AIF_MONITOR_MIN_WR_CYCLE (0x0898)
#define AIF_MONITOR_MAX_WR_CYCLE (0x089C)
#define AIF_MONITOR_READ_CYCLE_R (0x08A0)
#define AIF_MONITOR_WINDOW_CYCLE_R (0x08B0)
#define AIF_MONITOR_READ_DATA (0x08B4)
#define AIF_MONITOR_RD_CMD_CNT (0x08B8)
#define AIF_MONITOR_RD_DONE_CNT (0x08BC)
#define AIF_MONITOR_RBURST_CNT (0x08C0)
#define AIF_MONITOR_AVR_RDW_CYCLE (0x08C4)
#define AIF_MONITOR_MIN_RD_CYCLE (0x08C8)
#define AIF_MONITOR_MAX_RD_CYCLE (0x08CC)
#define AIF_MONITOR_CHANNEL_OS_ZR (0x08D0)
#define AIF_MONITOR_CHANNEL_OS_R0 (0x08E0)
#define AIF_MONITOR_CHANNEL_OS_R1 (0x08E4)
#define AIF_MONITOR_CHANNEL_OS_R2 (0x08E8)
#define AIF_MONITOR_AXI_OS_R (0x08EC)
#define AIF_MONITOR_CHANNEL_OS_ZR_W (0x08F0)
#define AIF_MONITOR_CHANNEL_OS_W0 (0x0900)
#define AIF_MONITOR_CHANNEL_OS_W1 (0x0904)
#define AIF_MONITOR_AXI_OS_W (0x090C)
...
#define CTL_RCH0_PMM_GATE (0x0080)
#define CTL_RCH1_PMM_GATE (0x0084)
#define CTL_RCH2_PMM_GATE (0x0088)
#define CTL_RCH3_PMM_GATE (0x008C)
#define CTL_RCH4_PMM_GATE (0x0090)
#define CTL_RCH5_PMM_GATE (0x0094)
#define CTL_RCH6_PMM_GATE (0x0098)
#define CTL_RCH7_PMM_GATE (0x009C)
#define CTL_OV2_PMM_GATE (0x00B0)
#define CTL_OV3_PMM_GATE (0x00B4)
...
#define DBUF_THD_RQOS_IDLE (0x00A8)
...
#define LCP_DEGAMA_LUT_SEL (0x044)
#define DEGAMA_EN (0x000)
#define DEGAMA_MEM_CTRL (0x004)
#define DEGAMA_LUT_SEL (0x00c)
#define DEGAMA_DBG0 (0x010)
#define DEGAMA_DBG1 (0x014)
#define GMP_EN (0x000)
...
#define BITEXT0_REG_INI0 (0x004)
#define BITEXT0_REG_INI1 (0x008)
#define BITEXT0_REG_INI2 (0x00C)
#define BITEXT0_REG_INI3 (0x010)
#define BITEXT0_THD_R0 (0x014)
#define BITEXT0_THD_R1 (0x018)
#define BITEXT0_THD_G0 (0x01C)
#define BITEXT0_THD_G1 (0x020)
#define BITEXT0_THD_B0 (0x02C)
#define BITEXT0_THD_B1 (0x028)
#define BITEXT0_DBG0 (0x02C)
...
#define MIPIDSI_PHY_TST_CLK_PRE_DELAY (0x00010020)
#define MIPIDSI_PHY_TST_CLK_POST_DELAY (0x00010021)
#define MIPIDSI_PHY_TST_CLK_TLPX (0x00010022)
#define MIPIDSI_PHY_TST_CLK_PREPARE (0x00010023)
#define MIPIDSI_PHY_TST_CLK_ZERO (0x00010024)
#define MIPIDSI_PHY_TST_CLK_TRAIL (0x00010025)
#define MIPIDSI_PHY_TST_DATA_PRE_DELAY (0x00010030)
#define MIPIDSI_PHY_TST_DATA_POST_DELAY (0x00010031)
#define MIPIDSI_PHY_TST_DATA_TLPX (0x00010032)
#define MIPIDSI_PHY_TST_DATA_PREPARE (0x00010033)
#define MIPIDSI_PHY_TST_DATA_ZERO (0x00010034)
#define MIPIDSI_PHY_TST_DATA_TRAIL (0x00010035)
#define MIPIDSI_PHY_TST_LANE_TRANSMISSION_PROPERTY (0x00010037)
#define MIPIDSI_PHY_TST_DATA_TA_GO (0x00010036)
#define MIPIDSI_PHY_TST_DATA_TA_GET (0x00010037)
