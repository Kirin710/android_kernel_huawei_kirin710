...
#define M3_RDR_LITTLE_CLUSTER_PROFILE_SIZE (0X280)
#define M3_RDR_BIG_CLUSTER_PROFILE_OFFSET (M3_RDR_LITTLE_CLUSTER_PROFILE_OFFSET + M3_RDR_LITTLE_CLUSTER_PROFILE_SIZE)
#define M3_RDR_BIG_CLUSTER_PROFILE_ADDR (M3_RDR_LITTLE_CLUSTER_PROFILE_ADDR + M3_RDR_LITTLE_CLUSTER_PROFILE_SIZE)
#define M3_RDR_BIG_CLUSTER_PROFILE_SIZE (0X280)
#define M3_RDR_GPU_BASE_PROFILE_OFFSET (M3_RDR_BIG_CLUSTER_PROFILE_OFFSET + M3_RDR_BIG_CLUSTER_PROFILE_SIZE)
#define M3_RDR_GPU_BASE_PROFILE_ADDR (M3_RDR_BIG_CLUSTER_PROFILE_ADDR + M3_RDR_BIG_CLUSTER_PROFILE_SIZE)
#define M3_RDR_GPU_BASE_PROFILE_SIZE (0X300)
