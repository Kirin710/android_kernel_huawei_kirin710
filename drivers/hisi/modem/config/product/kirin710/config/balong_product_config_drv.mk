...
CFG_CCPU_LLRAM_BASE_SIZE := 0x20000
CFG_CCPU_SRAM_SIZE  := 0x3000
CFG_DFC_LLRAM_BASE_ADDR        := (CCPU_LLRAM_BASE_ADDR + CCPU_SRAM_SIZE)
CFG_DFC_LLRAM_SIZE             := 0x1c800
CFG_MAILBOX_LLRAM_BASE_ADDR    := DFC_LLRAM_BASE_ADDR
CFG_MAILBOX_LLRAM_SIZE         := 0x0000
CFG_CPU_VIEW_LLRAM_ADDR        := ((MAILBOX_LLRAM_BASE_ADDR) + (MAILBOX_LLRAM_SIZE))
CFG_CPU_VIEW_LLRAM_SIZE        := 0x3000
CFG_SOCP_LLRAM_ADDR            := ((CPU_VIEW_LLRAM_ADDR) + (CPU_VIEW_LLRAM_SIZE))
CFG_SOCP_LLRAM_SIZE            := 0x8000
CFG_LL2_LLRAM_BASE_ADDR        := ((SOCP_LLRAM_ADDR) + (SOCP_LLRAM_SIZE))
CFG_LL2_LLRAM_SIZE             := 0x11800
...
CFG_CCPU_ITCM_SIZE := 0x4000
CFG_CCPU_ITCM_SIZE_CFG := (0x5u<<0x2)
...
CFG_FEATURE_NV_CARRIER_CUST := YES
CFG_FEATURE_NV_NO_MODEMNVM_SYS := YES
CFG_FEATURE_NV_SEC_ON := NO
CFG_FEATURE_KEEP_LEGICY_SEC_OS := YES
CFG_FEATURE_NV_RESUME_CUST := YES
...
CFG_FEATURE_SCI_ONLY_USE_SCI1           := FEATURE_OFF
CFG_CONFIG_SC := NO
CFG_CONFIG_DSP := NO
CFG_CONFIG_CBBE   := YES
...
CFG_CONFIG_DFS_DSP := YES
CFG_MIAMI_ATE := YES
CFG_FEATURE_TCM_RETENTION     := FEATURE_OFF
CFG_RFIC_CLK_STEADY_SLICE              := 3
...
CFG_CONFIG_ARM_BASLR_RELOC_SIZE := 0x1400000
...
CFG_DDR_MCORE_UNCACHE_SIZE              := 0x2000000
...
CFG_SHM_SIZE_SEC_DUMP			:=(0)
CFG_MODEM_SHARED_DDR_BASE  := (0x10000000)
CFG_MODEM_SOCP_DDR_BASE  := (0x10E00000)
CFG_DDR_SHA_NV_SIZE       := 0x700000
...
CFG_DDR_MNTN_ADDR         :=  ( (DDR_SOCP_ADDR        ) + (DDR_SOCP_SIZE           ) )
CFG_DDR_HIFI_ADDR         :=  ( (DDR_MNTN_ADDR        ) + (DDR_MNTN_SIZE           ) )
...
CFG_NV_COMM_BIN_FILE_MAX_SIZE       := 0x6DFC00
