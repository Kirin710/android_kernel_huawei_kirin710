...
#define DEFAULT_DSS_CORE_CLK_07V_RATE	(320000000UL)
#define DEFAULT_DSS_CORE_CLK_08V_RATE	(400000000UL)
...
#define DEFAULT_DSS_CORE_CLK_RATE	(320000000UL)
...
#define DEFAULT_DSS_MMBUF_CLK_RATE_L1	(271000000UL)
...
/*dss clk power off */
#define DEFAULT_DSS_CORE_CLK_RATE_POWER_OFF   	(271000000UL)
#define DEFAULT_DSS_PXL0_CLK_RATE_POWER_OFF    	(203000000UL)
#define DEFAULT_DSS_MMBUF_CLK_RATE_POWER_OFF 	(232000000UL)

#define OVL_PATTERN_RATIO (1)
#define OVL_LAYER_NUM_MAX (7)

/* the channel id which support arsr pre scaler */
#define ARSR_PRE_CH     (DSS_RCHN_V1)
...
#define HISIFB_DSS_PLATFORM_TYPE  (FB_ACCEL_DSSV320 | FB_ACCEL_PLATFORM_TYPE_ASIC)
